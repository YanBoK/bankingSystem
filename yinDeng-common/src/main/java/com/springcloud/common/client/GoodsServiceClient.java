...
public interface GoodsServiceClient {
	 ...
	 * @return
	 */
	@RequestMapping(value="/goods/goodsInfo/{goodsId}" , method = RequestMethod.GET)
	...
	public Result goodInfo(@RequestParam Map<String, Object> map);
	 ...
	 * @return
	 */
	@RequestMapping(value="/goods/goods",method = RequestMethod.POST)
	public Result goods(@RequestParam("goodsId") String goodsId,@RequestParam("orderId") String oderId);
